...
// Admin Routes
Route::get('/welcome/slug/{id}', [HomeController::class, 'welcome']);
Route::get('/blog_desc/{slug}', [HomeController::class, 'blog_desc']);
...
Route::get('admin/user-post-by-id/{id}',[AdminController::class,'usersById']);
